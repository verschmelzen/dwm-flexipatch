 ...
 * status2d patch. https://dwm.suckless.org/patches/statuscolors/
 */
 ...
 * current monitor. This patch takes precedence over centeredwindowname and
 * fancybar patches. https://dwm.suckless.org/patches/center/
 */
...
/* Port of InstantVM's on_empty_keys functionality allowing keybindings that
...
/* By default tags can be changed using MOD+<num> while MOD+Tab toggles between
 * the current and the previous tag. This patch changes this so that if you hit
 * MOD+<num> for the tag you are currently on, then it works the same as MOD+Tab
 * and switches back to the previous tag. Idea ref.
